...
kernel1 = base_model.layers[6].get_weights()[0]
bias1   = base_model.layers[6].get_weights()[1]
...
f = open('/content/drive/MyDrive/ColabNotebooks/data/Layer5.txt', 'w')

f.write("module layer5_1#(\n")
